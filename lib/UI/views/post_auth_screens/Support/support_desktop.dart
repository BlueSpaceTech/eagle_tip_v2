    ...
    return Container(
      ...
      child: Padding(
        padding: EdgeInsets.only(
            left: Responsive.isDesktop(context) ? width * 0.08 : width * 0.0),
        child: Row(
          ...
          children: [
            ...
            Align(
              ...
              child: Container(
                width:
                    Responsive.isDesktop(context) ? width * 0.45 : width * 0.9,
                height: height * 0.75,
            ...
            SizedBox(
              width: Responsive.isDesktop(context) ? width * 0.14 : width * 0.0,
            ),
            Responsive.isDesktop(context)
                ? Padding(
