...
class AddNewUserByTerminal extends StatefulWidget {
  AddNewUserByTerminal({Key? key}) : super(key: key);

  @override
  State<AddNewUserByTerminal> createState() => _AddNewUserByTerminalState();
}

class _AddNewUserByTerminalState extends State<AddNewUserByTerminal> {
  bool isselect = false;
  FToast? fToast;
